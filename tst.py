import numpy as np
#ეს არის ფუდამენტური პაკეტი კომპიუტინგისთვი
import pandas as pd
#გამოიყენება მონაცემებზე მანიპულაციისთვის. აქ ვგულისხმობ დატა ფრეიმებზე მუშაობას
import seaborn as sns
#მონაცემთა ვიზუალიზაცია
import matplotlib.pyplot as plt
#მონაცემთა დაპლოტვა.
#ვმუშაობ ჯერ კიდევ, მინდა რომ შექმნილი ვიზუალური შედეგი windows ფორმაში ავტომატურად გაიხსნა. ალბათ გამოვიყენებ tkinter ბიბლიოთეკას.
